...
ENABLE_TIME(lightweight_presign)

asymoff_lightweight_presigning_data_t **asymoff_lightweight_presigning_parties_new(asymoff_party_data_t ** const parties, uint64_t batch_size) 
{
  uint64_t num_parties = parties[0]->num_parties;
  ec_group_t ec        = parties[0]->ec;

  asymoff_lightweight_presigning_data_t **presign_parties = calloc(num_parties, sizeof(asymoff_lightweight_presigning_data_t*));
  asymoff_lightweight_presigning_data_t *party;
  
  for (uint64_t i = 0; i < num_parties; ++i) {

    presign_parties[i] = malloc(sizeof(asymoff_lightweight_presigning_data_t));
    ...
    if (i == 0) {
      ...
      party->offline = malloc(sizeof(asymoff_lightweight_presigning_data_offline_t));

      asymoff_lightweight_presigning_data_offline_t *offline = party->offline;

      offline->H       = gr_el_array_new(batch_size, ec);
      offline->alpha   = scalar_array_new(batch_size);
      offline->phi_sch = zkp_schnorr_new(ec);

      party->msg_to_offline = malloc(sizeof(asymoff_lightweight_presigning_msg_to_offline_t));
  
    } else { // i > 0

      party->online = malloc(sizeof(asymoff_lightweight_presigning_data_online_t));

      asymoff_lightweight_presigning_data_online_t *online = party->online;
    ...
    online->joint_B2 = gr_el_array_new(batch_size, ec);
      ...
      party->in_msg_1 = calloc(num_parties, sizeof(asymoff_lightweight_presigning_aggregate_msg_round_1_t));
      party->in_msg_2 = calloc(num_parties, sizeof(asymoff_lightweight_presigning_aggregate_msg_round_2_t));
      party->in_msg_3 = calloc(num_parties, sizeof(asymoff_lightweight_presigning_aggregate_msg_round_3_t));

      party->msg_from_offline = malloc(sizeof(asymoff_lightweight_presigning_msg_from_offline_t));
    }
  }
...
void asymoff_lightweight_presigning_parties_free(asymoff_lightweight_presigning_data_t **presign_parties)
{
  asymoff_lightweight_presigning_data_t *party;
...
void asymoff_lightweight_presigning_aggregate_round_1_hash(hash_chunk hash, asymoff_lightweight_presigning_aggregate_msg_round_2_t *msg_2, uint64_t batch_size, zkp_aux_info_t * const aux, ec_group_t ec) {
...
int asymoff_lightweight_presigning_aggregate_execute_round_1(asymoff_lightweight_presigning_data_t *party) {
  ...
  asymoff_lightweight_presigning_aggregate_msg_round_2_t msg_2;
  msg_2.B1 = online->B1;
  msg_2.B2 = online->B2;
  msg_2.phi_ddh_anchor = online->phi_ddh_anchor;
  msg_2.u = &online->u;

  asymoff_lightweight_presigning_aggregate_round_1_hash(online->T, &msg_2, batch_size, party->aux, ec);
...
uint64_t asymoff_lightweight_presigning_aggregate_send_msg_1(asymoff_lightweight_presigning_data_t *sender, asymoff_lightweight_presigning_data_t *receiver) {
  ...
  asymoff_lightweight_presigning_aggregate_msg_round_1_t *in_msg_1 = &receiver->in_msg_1[sender->i];
...
uint64_t asymoff_lightweight_presigning_aggregate_send_msg_2(asymoff_lightweight_presigning_data_t *sender, asymoff_lightweight_presigning_data_t *receiver) {
  ...
  asymoff_lightweight_presigning_data_online_t *online = sender->online;

  asymoff_lightweight_presigning_aggregate_msg_round_2_t *in_msg_2 = &receiver->in_msg_2[sender->i];
...
int asymoff_lightweight_presigning_aggregate_execute_round_3(asymoff_lightweight_presigning_data_t *party) {
  ...
  for (uint64_t j = 1; j < num_parties; ++j) {
    ...
    asymoff_lightweight_presigning_aggregate_msg_round_2_t *in_msg_2 = &party->in_msg_2[j];

    zkp_aux_info_update(party->aux, sizeof(hash_chunk), &j, sizeof(uint64_t));
    asymoff_lightweight_presigning_aggregate_round_1_hash(computed_T, in_msg_2, batch_size, party->aux, party->ec);
...
uint64_t asymoff_lightweight_presigning_aggregate_send_msg_3(asymoff_lightweight_presigning_data_t *sender, asymoff_lightweight_presigning_data_t *receiver) {
  ...
  asymoff_lightweight_presigning_data_online_t *online = sender->online;
  asymoff_lightweight_presigning_aggregate_msg_round_3_t *in_msg_3 = &receiver->in_msg_3[sender->i];
...
uint64_t asymoff_lightweight_presigning_send_msg_to_offline(asymoff_lightweight_presigning_data_t *sender, asymoff_lightweight_presigning_data_t *receiver) {
  ...
  asymoff_lightweight_presigning_data_online_t *online = sender->online;
  asymoff_lightweight_presigning_msg_to_offline_t *in_msg = receiver->msg_to_offline;
...
int asymoff_lightweight_presigning_execute_offline (asymoff_lightweight_presigning_data_t *party) {
  ...
  asymoff_lightweight_presigning_msg_to_offline_t *in_msg = party->msg_to_offline;
...
uint64_t asymoff_lightweight_presigning_send_msg_from_offline (asymoff_lightweight_presigning_data_t *sender, asymoff_lightweight_presigning_data_t *receiver) {
  ...
  asymoff_lightweight_presigning_data_offline_t *offline = sender->offline;
  asymoff_lightweight_presigning_msg_from_offline_t *in_msg = receiver->msg_from_offline;
...
int asymoff_lightweight_presigning_export_data(asymoff_party_data_t **parties, asymoff_lightweight_presigning_data_t ** const presign_parties) {
  ...
  asymoff_lightweight_presigning_msg_to_offline_t *to_offline = party->msg_to_offline;
